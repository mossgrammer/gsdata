...
<html>
  <head>
    <meta charset="utf-8">
    <title><?php echo "Add Printer"; ?></title>
...
<form class="form-horizontal" method="post" action="db/dbNewPrint.php">
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">PrinterName:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="text" name='PrintName' >
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">PO:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="text" name='PrintPO'>
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">IV:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="text" name='PrintIV' >
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">Service Tag:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="text" name='PrintService'>
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">Branch:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="text" name='PrintBranch'>
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">Depart:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="text" name='PrintDepart'>
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">Date:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="date" name='PrintDate'>
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">Note:</label>
<div class="col-sm-10">
  <textarea id="lable1" class="form-control" type="text" name='PrintNote'></textarea>
</div>
</div>
<div class="form-group">
