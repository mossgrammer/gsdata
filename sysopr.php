...
<html>
  <head>
    <meta charset="utf-8">
    <title><?php echo "Add Admin"; ?></title>
...
<form class="form-horizontal" method="post" action="db/dbAddAdmin.php">
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">Username:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="text" required="" name='Username' >
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">Password:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="password" required="" name='Password'>
</div>
</div>
<div class="form-group">
<label class="control-label col-sm-2" for="pwd">Name:</label>
<div class="col-sm-10">
  <input id="lable" class="form-control" type="text" name='Name' >
</div>
</div>
<div class="form-group">
